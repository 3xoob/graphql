...
exports.renderAuditCard = renderAuditCard;
...
async function renderAuditCard() {
    ...
    if (data !== null) {
        dataValues.appendChild((0, helpers_1.createDataElement)("Done ⬆", (0, helpers_1.formatSize)(data.done)));
        dataValues.appendChild((0, helpers_1.createDataElement)("Received ⬇", (0, helpers_1.formatSize)(data.received)));
    }
