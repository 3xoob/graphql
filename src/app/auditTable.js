...
exports.renderAuditTable = renderAuditTable;
...
async function renderAuditTable() {
    ...
    if (auditStatus) {
        auditStatus = (0, helpers_1.reverseAudits)(auditStatus);
    }
    ...
    if (auditStatus) {
        auditStatus.validAudits.nodes.forEach(audit => {
            ...
            const auditName = (0, helpers_1.getAuditNameFromPath)(audit.group.path);
