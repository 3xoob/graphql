...
export function createDataElement(label, value) {
...
export function createMediaLink(href, iconClass, backgroundColor) {
...
export function createDataElementHead(label, value) {
...
export function processUserSkillsData(userSkill) {
    const amounts = [];
    const types = [];
...
export function getAuditNameFromPath(path) {
    if (!path) {
        return '';
    }
...
export function reverseAudits(auditStatus) {
